...
export const getBlobToken = async (_req: Request, res: Response) => {
  try {
    return res.json({
...
export const uploadJsToExcel = async (req: Request, res: Response) => {
  try {
    const {
      fileUrl,
    } = req.body;
...
export const uploadExcelToJs = async (req: Request, res: Response) => {
  try {
    const {
      fileUrl,
    } = req.body;
...
export const uploadExcelToJsV2 = async (req: Request, res: Response) => {
  try {
...
export const uploadExcelMerge = async (req: Request, res: Response) => {
  try {
...
export const uploadExcelMergeZip = async (req: Request, res: Response) => {
  try {
    const {
      file1Url,
      file2Url,
...
export const generateExcelForEachLocales = async (req: Request, res: Response) => {
  try {
    const {
      fileUrl,
      workSheetKey = 1,
...
export const generateExcelForEachLocalesV2 = async (req: Request, res: Response) => {
  try {
    const {
      fileUrl,
      workSheetKey = 1,
...
export const compareTwoJs = async (req: Request, res: Response) => {
  try {
...
export const compareTwoExcels = async (req: Request, res: Response) => {
  try {
    const {
...
export const translateExcel = async (req: Request, res: Response) => {
  try {
...
export const translateJs = async (req: Request, res: Response) => {
  try {
